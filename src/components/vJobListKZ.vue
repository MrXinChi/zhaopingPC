<template>
	<div class="job_wrapper">
		<div class="job_list">
			<div class="job_item" v-for="(item,i) in deliverList" @click="handleClick(item.id)" :key="i" :style="'background-color:'+backgroundColor">
				...
				<div class="wrapper_right">
					<div class="company_name flex flex_x_right">{{item.com_id_name}}</div>
					<div class="sign">
					...
					<button class="collections" v-if="type=='collection'" @click="handleCancelCollection(i)">取消收藏</button>
				</div>
			</div>
